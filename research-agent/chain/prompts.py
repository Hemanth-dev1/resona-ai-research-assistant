...
ANALYST_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "this means NO real sources exist for this topic. In this case:\n"
...
WRITER_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "## SPECIAL CASE: NO SOURCES AVAILABLE\n"
        "If the analysis contains 'has_sufficient_evidence: false' and ZERO [S#] "
        "citation tags (meaning no real sources exist), then:\n"
